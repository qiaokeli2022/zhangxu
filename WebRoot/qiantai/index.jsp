  ...
  <jsp:include flush="true" page="top.jsp"/>
	...
	<tr><td height="10" colspan="2"></td></tr>
		<tr>
			...
			<td>
			<div align="center">
				<table border="0" width="587" cellspacing="0" cellpadding="0" background="resources/img/maininfo.gif" height="247" id="table2">
					<tr>
						<td>
		...
		<tr>
			...
			<table border="0" width="93%" cellspacing="0" cellpadding="0" height="100%">
				<tr>
					<td width="55" height="34" background="resources/img/th_img2.gif">　</td>
					<td background="resources/img/th_bg.gif"><b><font color="#ff9900">&nbsp;最新推荐图书</font></b></td>
				</tr>
				<tr>
					<td>　</td>
					<td>
                ...
                for(int i = n*3-3;i < alNewly.size();i++){
                  ...
                  %>
                        ...
                        <table border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                              <td>&nbsp;每日租金：<%=alNewlyRow.get(5)%>元</td>
                            </tr>
                            <tr>
                              <td>&nbsp;库 存 量：<%=alNewlyRow.get(6)%></td>
                            </tr>
                            <tr>
                              <td align="center">
                              <%
                              ...
                              %>
                              <a href="qiantai/loan_book.jsp?bookId=<%=alNewlyRow.get(0)%>"> <img height="18" src="resources/img/goumai.gif" width="40" border="0" alt=""/> </a>
                              <%}else{ %>
                              <a href="qiantai/beforehand_book.jsp?bookId=<%=alNewlyRow.get(0)%>"> <img height="18" src="resources/img/goumai1.gif" width="40" border="0" alt=""/> </a>
                              <%} %>
                               </td>
                            </tr>
                          </table><br></td>
				...
				<tr>
					<td width="55" height="34" background="resources/img/th_img.gif">　</td>
					<td background="resources/img/th_bg.gif">&nbsp;<b><font color="#66cc00">最新上架图书</font></b></td>
				</tr>
				<tr>
					<td>　</td>
					<td>
