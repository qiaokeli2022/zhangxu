...
<html>
  <head>
	...
	<link href="resources/img/css.css" type="text/css" rel="stylesheet"/>
 ...
 %>
  ...
  <table bgcolor="#ffcc00" border="0" cellpadding="1" cellspacing="1" align="center" width="620">
		...
		<tr bgcolor="#fff9ec">
            ...
            <img src="resources/img/trash.gif" border="0" height="17" width="15" alt="">
          	</a>
			</td>
		</tr>
		<%}%>
		...
		<tr bgcolor="#ffffff">
			<td colspan="6" align="center">
				<a href="qiantai/index.jsp">
		          <img alt="" src="resources/img/cart01.gif" border=0/>
		        </a>
		        <a href="servlet/ShoppingServlet?remove=1">
		          <img alt="" src="resources/img/cart02.gif" border=0/>
		        </a>
		        <a href="servlet/ReckoningServlet">
		          <img alt="" src="resources/img/cart04.gif" border=0/>
		        </a>
		     </td>
		</tr>
