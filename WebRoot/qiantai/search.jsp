              ...
              <%break;}} %>
					...
					<td align="center">						
						...
						if(!alRow.get(6).equals("0")){
							%><a href="qiantai/loan_book.jsp?bookId=<%=alRow.get(0)%>"><img src="resources/img/goumai.gif" border="0" /><%
						}else{
						 %>
                        	<a href="qiantai/beforehand_book.jsp?bookId=<%=alRow.get(0)%>"><img src="resources/img/goumai1.gif" border="0" />
                        	<%} %>
                        </a>
					</td>
				</tr>
